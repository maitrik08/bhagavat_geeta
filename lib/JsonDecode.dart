import 'dart:convert';
import 'package:bhagavat_geeta/AllchapterModel.dart';
import 'package:bhagavat_geeta/ChapterModel.dart';
...
class ChapterJsonDecodeProvider extends ChangeNotifier {
  ...
  Future<void> loadJSON() async {
    ...
    await rootBundle.loadString('aseets/all_chapters.json');
    chapterJsonDecodeModel.decodedList = jsonDecode(chapterJsonDecodeModel.data);
...
class ShlokJsonDecodeProvider extends ChangeNotifier {
  ...
  englishLanguage() {
    shlokJsonDecodeModel.allShloks[shlokIndex].translation = shlokJsonDecodeModel.allShloks[shlokIndex].english;
    notifyListeners();
  }

  hindiLanguage() {
    shlokJsonDecodeModel.allShloks[shlokIndex].translation = shlokJsonDecodeModel.allShloks[shlokIndex].hindi;
    notifyListeners();
  }

  gujaratiLanguage() {
    shlokJsonDecodeModel.allShloks[shlokIndex].translation = shlokJsonDecodeModel.allShloks[shlokIndex].gujarati;
    notifyListeners();
  }
}